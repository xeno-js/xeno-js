import type { Delegate, IBaseRequest, IPipelineBehavior, IStrategy, ResultType } from '@/domain'
...
> implements IPipelineBehavior<TInput, TResult> {
   ...
   */
  constructor(private readonly _validators: readonly IStrategy<boolean>[]) {}
