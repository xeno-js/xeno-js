 ...
 */
export class PermissionAuthorizationStrategy extends BaseAuthorizationStrategy<IBaseRequest> {
  ...
  protected performAuthorizationCheck(
    ...
    const hasRequiredPermission = command.permissions?.some((permission) =>
