 ...
 */
export class Composite implements IPipelineBehavior {
  /**
   * @description Constructs a new instance of the Composite class, which takes an optional array of IPipelineBehavior instances. If no behaviors are provided, it initializes with an empty array. The composite pipeline will execute each behavior in the order they were provided, allowing for a flexible and modular approach to handling requests in a CQRS architecture.
   ...
   */
  constructor(private readonly _pipelines: readonly IPipelineBehavior[] = []) {}
