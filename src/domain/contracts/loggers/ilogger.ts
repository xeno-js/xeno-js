...
export interface ILogger {
   ...
   */
  info(message: string, context: Optional<Dictionary<unknown>>): void
  /**
   * Log a message at the warning level with an optional context.
   * @param message The message to log.
   * @param context An optional dictionary containing additional context for the log message.
   */
  warn(message: string, context: Optional<Dictionary<unknown>>): void
  /**
   ...
   * @param context An optional dictionary containing additional context for the log message.
   */
  error(message: string, error: Optional<Error>, context: Optional<Dictionary<unknown>>): void
  /**
   * Log a message at the debug level with an optional context.
   * @param message The message to log.
   * @param context An optional dictionary containing additional context for the log message.
   */
  debug(message: string, context: Optional<Dictionary<unknown>>): void
  /**
   * Track an exception with an optional context.
   * @param error The error to track.
   * @param context An optional dictionary containing additional context for the error.
   */
  trackException(error: Error, context: Optional<Dictionary<unknown>>): void
}
