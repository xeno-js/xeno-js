...
import type { AuthClaims, HttpHeaders, HttpMethod, Metadata, Optional, UserContext } from '@/shared'
...
export type ApplicationRegistry<T = unknown> = {
  ...
  /** @description Token used to register and resolve the RouterRegexMatcher instance in the dependency injection container.
   *
   * @author Xeno
   * @version 1.0.0
   * @since 2025-09-30
   * @link https://github.com/Mattia-Carcione/xeno-js
   */
  readonly ROUTE_MATCHER: IMatcher<{ method: HttpMethod; path: string }>
