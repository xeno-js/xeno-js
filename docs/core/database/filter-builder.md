...
Gear5 criteria are framework-level objects. Drizzle expects SQL expressions and
...
The supported operators in Gear5 criteria are:
...
```ts
import type { IFilterBuilder, ReadCriteria, WriteCriteria } from '@gear5/core'
