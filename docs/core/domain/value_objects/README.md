...
intersect completely. Within Gear5, this contract is implemented by the
...
Value Objects cannot use standard reference comparisons (`vo1 === vo2`). Gear5
...
```typescript
import { ValueObject } from '@gear5/core'
