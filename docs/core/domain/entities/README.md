...
lifecycle, spanning across multiple system-state mutations. Within the Graviton5
...
`number`) to model entity identities. Graviton5 wraps values inside a dedicated
...
export class Customer extends Entity<CustomerProps> {
  ...
  public deactivateAccount(): void {
    ...
    // Inside Graviton5, props are frozen on construction to lock state stability:
