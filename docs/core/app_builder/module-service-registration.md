...
The Gear5 core framework remains agnostically uncoupled from your explicit
...
```typescript
import type { IModule, IServiceContainer } from '@gear5/core'
import { TokenHelper } from '@gear5/core'
