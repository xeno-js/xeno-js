...
Welcome to the live executable demonstration suite of the Graviton5 framework.
This section provides a hands-on exploration of complete, decoupled architecture
...
- **[CQRS & Mediator Pipeline](https://github.com/Mattia-Carcione/Graviton5/tree/develop/demo/pipelines_middleware_demo)**
...
- **[Database & Drizzle ORM Integration](https://github.com/Mattia-Carcione/Graviton5/tree/develop/demo/database_drizzle_demo)**
  ...
  with PostgreSQL.
- **[Resilient HTTP Core Subsystem](https://github.com/Mattia-Carcione/Graviton5/tree/develop/demo/http_core_demo)**
...
- **[Full Middleware & Context Integration](https://github.com/Mattia-Carcione/Graviton5/tree/develop/demo/pipelines_middleware_demo)**
...
local node module ecosystem, like this:

```bash
cd demo/http_core_demo #or another dir
npm install
npm run dev
```
