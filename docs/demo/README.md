...
Welcome to the live executable demonstration suite of the XenoJS framework. This
...
- **[CQRS & Mediator Pipeline](https://github.com/Mattia-Carcione/XenoJS/tree/develop/demo/pipelines_middleware_demo)**
...
- **[Database & Drizzle ORM Integration](https://github.com/Mattia-Carcione/XenoJS/tree/develop/demo/database_drizzle_demo)**
  ...
  with PostgreSQL.
- **[Resilient HTTP Core Subsystem](https://github.com/Mattia-Carcione/XenoJS/tree/develop/demo/http_core_demo)**
...
- **[Full Middleware & Context Integration](https://github.com/Mattia-Carcione/XenoJS/tree/develop/demo/pipelines_middleware_demo)**
